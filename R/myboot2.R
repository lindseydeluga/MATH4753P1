...
#' @param cx number indicating the amount by which plotting text and symbols should be scaled relative to the default
#' @param ...
#'
#' @return
#' @export
#'
#' @examples myboot2(10000,x=sam,fun="mean",alpha=0.05,xlab="mean",col="cadetblue3",cx=1.5)
#'
#'
#'
